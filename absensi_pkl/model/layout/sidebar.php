<ul class="nav nav-sidebar">
	...
	if (isset($_SESSION['pb'])) {
		...
		$name = array("", "Tambah Mahasiswa", "Daftar Mahasiswa", "Absen", "Lihat Absensi", "Tugas", "Nilai Tugas", "Ubah Katasandi", "Keluar");
		...
		$name = array("", "Absen", "Absensiku", "Tugas", "Status Tugas", "Keluar");
