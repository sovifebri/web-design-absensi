<h3 class="page-header">Tambah Mahaiswa Baru</h3>
<?php
if (isset($_GET['st'])) {
  if ($_GET['st'] == 1) {
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">NRP:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="nis" placeholder="Masukan NRP" required>
    </div>
  </div>
